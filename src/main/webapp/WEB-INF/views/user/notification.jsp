		...
		<form action="/setExchangeAlert" method="post">
			...
			<div class="charts_view">
				<div class="charts_container">
					<!-- 각 통화의 그래프와 정보 표시 -->
					<div class="chart_graph_box_container" id="USD-chart"
						style="display: none;">
					...
					<div class="chart_graph_box_container" id="JPY-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="EUR-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="CNY-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="GBP-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="CHF-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="CAD-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="INR-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="HKD-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="EGP-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="SAR-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="AUD-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="THB-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="RUB-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="VND-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="ZAR-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="MXN-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="BRL-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="ILS-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
					...
					<div class="chart_graph_box_container" id="NZD-chart"
						style="display: none;">
						<div class="chart_graph_box">
							<div class="chart_graph_box_top">
								<img
