...
<body>
	...
	<div id="main">
		<h1>아이디 찾기</h1>
		<p>아이디 찾기를 위해 이메일이나 휴대폰을 선택해주세요.</p><br>
		
		<div class="box-container">
        	<div class="box" onclick="selectBox(this)">
          		<a href="#" onclick="reg_type_select('email'); return false;">
                	<img src="${pageContext.request.contextPath}/resources/img/free-icon-email.png" alt="" style="width: 40px; height: auto;">
                	이메일 확인
            	</a>
        </div>
        	<div class="box" onclick="selectBox(this)">
            	<a href="#" onclick="reg_type_select('pcs'); return false;">
                	<img src="${pageContext.request.contextPath}/resources/img/free-icon-phone.png" alt="" style="width: 40px; height: auto;">
                	휴대폰 확인
            	</a>
        	</div>
    	</div>	
		...
		<div class="type_email" style="display: none;">
			...
			<form action="/ex/find/idInquiryDB?type=email" method="post">
				...
				<div class="input-container">
					...
					<select class="input" name="select" class="input">
