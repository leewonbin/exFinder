...
<body>
	...
	<div class="main">
		...
		<div>
			<button class="cButton" data-value="">전체글보기</button>
			<button class="cButton" data-value="공지사항">공지사항</button>
			<button class="cButton" data-value="자유게시판">자유게시판</button>
			<button class="cButton" data-value="고객센터">고객센터</button>
