		...
		<div class="slide-controls">
			<div class="Cover-button-box">
				<button id="prev-slide">
					<img src="${pageContext.request.contextPath}/resources/img/arrow.png"
			...
			<div class="chart_graph_box_slide" id="slide-container">
				...
				<div class="chart_graph_box">
					<div class="chart_graph_box_top">
						<img src="${pageContext.request.contextPath}/resources/img/gonfalon/${exchange.c_code}.png">
						<a href="exFinder_Currency?c_code=${exchange.c_code}">${exchange.c_country} ${exchange.c_code}</a>
