	...
	public int exchangeRateInsert(ExchangeRateDto dto) throws Exception {
	 ...
	 public ArrayList<ExchangeRateDto> checkExchange(String[] currency, String startDate, String endDate) {
	        ...
	        try {
	            ...
	            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10)); // Selenium 4에서 Duration 사용
	            ...
	            for (String curr : currency) {
	                ...
	                // 조회 버튼 클릭
	                WebElement searchButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"frm\"]/fieldset/div/span/input")));
	                searchButton.click();

	                // 조회 완료 대기
	                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"fxprint\"]/table")));
