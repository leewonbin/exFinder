...
public class CommentController {
	...
	public String createComment(@RequestParam("b_id") int b_id, @RequestParam("comm_content") String comm_content,
	...
	public String createReComment(@RequestParam("comm_id") int parent_id, @RequestParam("b_id") int b_id,
			@RequestParam("comm_content") String comm_content, HttpSession session) {
		try {
			UserDto userDto = (UserDto) session.getAttribute("dto");
